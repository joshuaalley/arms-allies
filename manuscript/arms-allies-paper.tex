...
% At the same time, these treaties increase the risk states will become involved in war without allied support? 
...
But the additional components add substantial value, first by connecting the argument and research design.%\footnote{See the appendix for a robustness check of the multilevel model results with a single-level regression.} 
