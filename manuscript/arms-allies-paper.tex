...
The argument emphasizes differences in state capability, which I express by dividing states between major and non-major powers. 
While this division ignores distinctions among states within the two groups, particularly middle powers and superpowers, it provides a sharp distinction.
The clarity of the divide ensures the argument and empirical test provide a clear contrast. 
The sharp division comes at the cost of nuance and fine-grained inferences in the empirical section. 
...
This approach treats heterogeneous effects of alliance participation on military spending as given, and uses treaty characteristics to explain variation across alliances. 
...
Specific studies examine a few treaties at a time, while general research designs aggregate multiple treaties into a single measure. 
...
The institutional design and membership of the OAS and Rio pact alter their respective $\lambda$ parameters.
...
Such treaties are rare- only SEATO, NATO, the US-Japan alliance after 1991, and a treaty between the US, UK and USSR to ensure Soviet intervention against Japan meet this criteria. 
...
More importantly, my argument does not anticipate a huge qualitative difference between major powers and superpowers. 
Both sets of states seek foreign policy gains far beyond their immediate territorial security.
For example, French involvement in Africa today and Britain's foreign policy after World War II exceed the ambitions of most non-major powers.
...
There is no theoretical reason to anticipate that the impact of treaty scope would differ between major powers and super powers, and careful attention to alliances between the super and major powers can highlight any limitations. 
...
Each $\lambda$ parameter measures the impact of treaty participation, which is modified by treaty characteristics. 
If treaty scope has a large influence on alliances, it will produce large changes in the $\lambda$ estimates. 
Therefore, we should observe trends in the mean of $\lambda$ across the range of alliance treaty scope.
...
Narrow treaties often reduce growth in military spending among non-major powers, while most broad treaties have little impact on or add to growth in military spending. 
...
Trends in the $\lambda$ parameters across the range of treaty scope suggests that treaty scope has a substantial impact. 
...
To further illustrate the explanatory power of my argument, the next section offers a brief description of key dynamics in US alliance politics.   
...
Additional entanglement in a broad treaty provides more influence, limiting the positive correlation between alliance participation and growth in military spending. 
...
Alliances are more foreign entanglement for major powers and more force multiplier for non-major powers, but the consequences of alliance participation also shaped by treaty characteristics.  
