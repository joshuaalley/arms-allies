...
I test the argument by creating a latent measure of alliance treaty depth and employing it in a multilevel model. 
...
But alliance participation could plausibly increase or decrease defense expenditures, given differences in alliance design. 
...
The United States often uses deep alliances to reassure partners. 
Reassurance may encourage lower allied military spending, however. 
...
Non-major powers can gain more security with less military spending, even in the face of significant threats, if they form deep alliances. 
Conversely, security gains in shallow alliances may depend on non-major powers maintaining or even increasing their military spending to manage abandonment concerns. 
...
I challenge this assumption by showing that alliance participation sometimes requires non-major powers to increase defense expenditures. 


% Summarize the flow of the argument
I start the argument by describing a general framework, which treats alliances as institutionalized military cooperation between states. 
...
As a result, there are distinct processes behind non-major and major power alliance participation, so these states respond to allied capability and treaty design in different ways. 
...
In treaty design, depth, unconditional military support \citep{Benson2012, Chibaetal2015} and issue linkages \citep{LongLeeds2006, Poast2012, Poast2013} are all sources of credibility.\footnote{Though the argument emphasizes depth, the research design accounts for multiple sources of alliance credibility.}
...
If alliance participation can reduce non-major power military spending, is that always problematic for allies? 
This argument assumes that allied states have mixed preferences about non-major power military spending. 
On the one hand, greater non-major power military spending increases their ability to contribute to the foreign policy goals of the alliance. 
But more military capability also gives non-major powers strategic autonomy, which can be a concern.\footnote{For example, the United States has inhibited nuclear acquisition by many allies \citep{Gavin2015}.} 
Thus, allies do not uniformly prefer high or low non-major power defense expenditures, and the balance between these preferences can shift over the life of the alliance. 
%In general, allies start treaty design by dealing with credibility concerns to ensure that the alliance provides foreign policy benefits, before bargaining over military spending. 
...
% Need leverage 
Therefore, if alliance members want to encourage greater allied defense spending, they must have leverage. 
...
Under less credible alliances, failure to spend on the military could increase the risk of abandonment, so members have less freedom to reduce defense spending. 
...
% Efficiency argument
Second, credibility in deep alliances can facilitate more efficient defense spending. 
...
Therefore, with a continuous conceptualization of depth, there should be a negative correlation between treaty depth and the impact of alliance participation on non-major power military spending as the positive effects of shallow treaties turn into negative effects in the deepest alliances. 
...
Before detailing how I test these hypotheses, I must briefly justify two conceptual and measurement decisions. 
...
Measuring participation using allied capability matches my argument and encompasses the division in research designs across previous studies. 
...
These correlations can produce misleading inferences about latent scores, so I employ a different estimator.
...
I use a multilevel model to capture this relationship, and summarize this estimation strategy in the next section. 
...
In international politics states can participate in multiple alliances and alliances could have heterogeneous effects on military spending.
...
If a state is not in the alliance, the corresponding matrix cell is zero.
...
State-year observations with and without alliances are part of the sample. 
...
This alliance-level depth coefficient has a substantive effect on growth in military spending, which I plot in the bottom panel of \autoref{fig:results-allreg}. 
...
Although some estimated substantive effects are quite small, there is a perceptible difference between non-major power military spending growth in deep and shallow alliances, all else equal.  
...
To assess the annual impact of alliances on their members, I multiplied the alliance membership matrix $\textbf{Z}$ by the $\lambda$ parameters to generate 9,124 state-alliance-year predictions.\footnote{These estimates hold all state-level variables constant.} 
...
Some of the deepest alliances have a negligible effect on military spending despite negative $\lambda$ values because they have limited capability. 
...
Second, the military spending growth predictions in \autoref{fig:results-allpred} suggest that many alliances have little effect on military spending, which are puzzling given widespread expectations that alliances and military spending are related. 
