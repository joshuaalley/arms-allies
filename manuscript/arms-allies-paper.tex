...
% justify emphasis
%I focus on small alliance members to maintain theoretical and empirical parsimony.
...
I model the outcome using a double-exponential distribution address heavy tails.
...
Because other treaty characteristics and chance also influence the $\lambda$ estimates, there is substantial variation in how alliance participation impacts junior member power military spending. 
