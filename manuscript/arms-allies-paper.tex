...
Debate between the force multiplier and foreign entanglement perspectives largely ignores heterogeneity among alliances, which prior scholarship shows is closely connected to the risk of war \citep{Leeds2003, LeedsAnac2005, Mattes2012, Benson2012}.  
Differences between alliances imply that participation could increase or decrease defense expenditures. 
...
By adding to major power influence, deep treaties reduce the need for additional military spending. 
Thus, deep treaty commitments lead to lower growth in major power military spending than shallow treaties.  
...
Thus, deeper treaties increase growth in non-major power military expenditures, relative to shallow treaties. 
...
A greater cost per taxpayer reduces voters' demand for military spending. 
...
Deep commitments stipulate a wider range of costly cooperation among members.
...
A shallow treaty would only have the promise of military support, or an even weaker obligation such as consultation.  
...
A broad formal commitment stipulates deeper engagement abroad. 
...
Deep formal treaties with extensive promises of military support and additional costly commitments are therefore better sources of influence.
...
Therefore, greater treaty scope substitutes for growth in major power military spending--- broader treaties will lead to lower spending growth than narrow treaties. 


Britain's alliances in the Middle East after World War II illustrate how major powers can use deep treaties to substitute for investment in military capability. 
...
Most treaties require growth in spending, but a deeper treaty provides equivalent influence with less growth in defense expenditures. Therefore, growth in major power military spending from alliance participation will be positive and decreasing in treaty scope. 
...
When these states prioritize domestic consumption, shallow commitments follow. 
...
Deeper ties give allies influence to demand higher defense spending than in a shallow treaty. 
...
But France offered a treaty with quite limited scope, giving Poland the freedom to reduce military spending. 
The agreement between France and Belgium formed deeper ties, which led Belgium to spend more on their military. 
...
Even a deep treaty may increase growth in military spending, however. 
...
Deeper treaties attenuate the negative correlation between alliance participation and military spending in non-major powers. 
...
For face validity, the UAR is a deeper commitment than a promise to respect Belgian neutrality. 
...
This research design adds complexity to a more traditional panel data specification. 
...
Therefore the impact of an alliance on members military spending depends on treaty characteristics, including scope. 
...
A change in treaty scope changes $\lambda$, which in turn affects growth in military spending.
...
Though the executive branch sought a deep NATO treaty, isolationist fears of foreign entanglement constrained its formal scope. 
...
But additional entanglement in a deep treaty provides more influence, limiting the positive correlation between alliance participation and growth in military spending. 
...
First, my findings reinforce calls to consider heterogeneity among alliances \citep{Leeds2003, DigiuseppePoast2016}.
...
Beyond the immediate issue of alliance participation and military spending, the research design in this paper applies to other international relations questions.
