...
Not all alliances are equally credible. Strength depends on costs an ally incurs or would incur. 

\begin{itemize} 
\pause
\item Costs of abrogation: breaking promises of support.
\pause
\item Sunk costs promises: commitment to take costly action. 
\pause
\item More foreign policy gains with stronger treaty. 
\pause 
\item But hands tying limits freedom of action for members. 
\end{itemize}  
...
\uncover<4->{\item Strong treaties $\uparrow$ influence} 
\end{itemize} 
\end{column}
...
\uncover<7->{\item Strong treaties restrict freedom of action.} 
\end{itemize} 
...
%\hline
%Major Power & (1)  $\downarrow$ Growth Spending   & (2)  $\uparrow$ Growth Spending        \\
%\hline
%Non-Major Power & (3) $\uparrow$ Growth Spending   & (4) $\downarrow$ Growth Spending       \\ 
%\hline 
%\end{tabular}
%}
